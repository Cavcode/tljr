...
void main()
{
    ...
    //Change Heads for special races
    string sTag = GetTag(OBJECT_SELF);
    if (sTag == "TrandoshanBodyguard" || sTag == "TrandoshanBountyhunter")
    {
        SetCreatureBodyPart(CREATURE_PART_HEAD, 203, OBJECT_SELF);
    }
    else if (sTag == "TwilekBodyguard")
    {
