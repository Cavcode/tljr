...
void DoDiceBagFunction(int iDice, object oUser, int iDMOverride = 0)
{
    ...
    switch(iDice)
    {
        ...
        case 71: iNum = 1; iSide = 20; iTrain = 1; sAbility="Handle Animal Check, "; iMod = GetSkillRank(SKILL_ANIMAL_EMPATHY, oUser); break;
        ...
        case 78: iNum = 1; iSide = 20; iTrain = 1; sAbility="Disable Device Check, "; iMod = GetSkillRank(SKILL_DISABLE_TRAP, oUser); break;
        ...
        case 85: iNum = 1; iSide = 20; sAbility="Knowledge Check, "; iMod = GetSkillRank(SKILL_LORE, oUser); break;
        case 86: iNum = 1; iSide = 20; sAbility="Move Silently Check, "; iMod = GetSkillRank(SKILL_MOVE_SILENTLY, oUser); break;
        case 87: iNum = 1; iSide = 20; iTrain = 1; sAbility="Security Check, "; iMod = GetSkillRank(SKILL_OPEN_LOCK, oUser); break;
        ...
        case 94: iNum = 1; iSide = 20; iTrain = 1; sAbility="Demolitions Check, "; iMod = GetSkillRank(SKILL_SET_TRAP, oUser); break;
        ...
        case 99: iNum = 1; iSide = 20; iTrain = 1; sAbility="Use Advanced Technology Check, "; iMod = GetSkillRank(SKILL_USE_MAGIC_DEVICE, oUser); break;
