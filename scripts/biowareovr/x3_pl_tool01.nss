...
void main()
{
    ...
    SendMessageToPC(oUser, "Alternate rest menu activated.");
    //SetLocalInt(oUser,"GY_ReallyResting",TRUE);
    AssignCommand(oUser,ClearAllActions());
    AssignCommand(oUser,ActionStartConversation(oUser, "mod_rest", TRUE, FALSE));
