...
void main()
{
    //Pug's Modifications for treasure

  /*  object oChest = GetObjectByTag("LOOT_"+GetTag(OBJECT_SELF));
    int nRoll = Random(10)+1;    object oPrize;
    ...
    */
    ...
    if (GetTag(OBJECT_SELF) == "ElderWampa")
        {
            SetObjectVisualTransform(OBJECT_SELF,OBJECT_VISUAL_TRANSFORM_SCALE,1.5);
        }

    if (GetRacialType(OBJECT_SELF) == RACIAL_TYPE_CONSTRUCT)
        {
