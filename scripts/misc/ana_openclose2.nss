//Modified zep_openclose script for the central door to central fort inside
//Anatheme 29/08/2007
//In addition to opening or closing the placeable, it will move the opener
//inside the fort.
//::///////////////////////////////////////////////
//:: ZEP_OPENCLOSE.nss
...
//:: Modified by: Anatheme 8-29-07 for IoSS
//:://////////////////////////////////////////////
...
void main()
{
    ...
    if (nIsOpen == 0)   //if the item is a door
    {
        ...
        PlayAnimation(ANIMATION_PLACEABLE_OPEN);
        DelayCommand(4.0, ExecuteScript("ana_openclose2", OBJECT_SELF));
        DelayCommand(2.0, AssignCommand(oPC, ActionJumpToLocation(GetLocation(GetWaypointByTag("WP_TidalToSouthern")))));
//        FloatingTextStringOnCreature("I should be jumping inside the fort", oPC, FALSE);
