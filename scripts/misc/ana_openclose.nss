...
void main()
{
    ...
    if (nIsOpen == 0)   //if the item is a door
    {
        ...
        PlayAnimation(ANIMATION_PLACEABLE_OPEN);
        DelayCommand(4.0, ExecuteScript("ana_openclose", OBJECT_SELF));
        DelayCommand(2.0, AssignCommand(oPC, ActionJumpToLocation(GetLocation(GetWaypointByTag("WP_FortToCentral")))));
