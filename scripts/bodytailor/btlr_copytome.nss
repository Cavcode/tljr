...
// Tattoo colours, added by Pug
    SetColor(oPC, COLOR_CHANNEL_TATTOO_1, GetColor(oSelf, COLOR_CHANNEL_TATTOO_1));
    SetColor(oPC, COLOR_CHANNEL_TATTOO_2, GetColor(oSelf, COLOR_CHANNEL_TATTOO_2));
